...
def parse_args():
    ...
    parser.add_argument('--root', default='/gpfs/scratch/azerroug/ILSVRC/Data/CLS-LOC/', \
                        type=str, help="ImageNet root directory")
    parser.add_argument('--save', default='/users/mvaishn1/data/data/mvaishn1/fossil/ImageClassification/', \
                        type=str, help="Result saving directory")
