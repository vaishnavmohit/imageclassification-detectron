...
python train_net_builtin.py --num-gpus 4 --dist-url tcp://127.0.0.1:12349  --config-file configs/Base_image_resnet_torch.yaml --resume
                            # SOLVER.IMS_PER_BATCH 1014 OUTPUT_DIR "../../dump/fossil/imagenet/5mar-nor-condo/"

#sbatch -J fossil scripts/train_net_builtin_he.sh 